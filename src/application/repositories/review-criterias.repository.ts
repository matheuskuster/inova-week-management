...
export abstract class ReviewsCriteriasRepository
  implements RepositoryInterface<ReviewCriteria>
{
  ...
  public abstract findManyByInovaId(inovaId: string): Promise<ReviewCriteria[]>;
}
